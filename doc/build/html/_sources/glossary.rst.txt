...
.. glossary::
   ...
   annotation
      ...
      Used to describe what :term:`type` an argument takes

      https://www.python.org/dev/peps/pep-0526/

   attribute

      An attribute is the term used to describe variables associated with a :term:`class`
      that contains information about that class' state.

   attributes

      plural of :term:`attribute`
   ...
   metaclass
      ...
      A python :term:`class` definition that inherits from `type`.
      It allows programmers to customize class creation as if they typed the entire class
   ...
   type
      ...
      a data type or simply type is a classification of data which tells the compiler or
